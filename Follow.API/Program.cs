...
using Follow.API.Repositories;
using Follow.API.Repositories.Interfaces;
using Follow.API.Services;
...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("Service", "Follow.API") // change per service
    .CreateLogger();
builder.Host.UseSerilog();

// ── Database ───────────────────────────────────────────────────────────────
builder.Services.AddDbContext<FollowDbContext>(opt =>
